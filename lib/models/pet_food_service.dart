  ...
  static List<PetFoodModel> getAllPetFoods() {
    return [
      DogFood(
        ...
        category: 'Dry Food',
        price: 150000,
        imageUrl: 'https://via.placeholder.com/150x150?text=Royal+Canin',
      ...
      CatFood(
        ...
        category: 'Wet Food',
        price: 45000,
        imageUrl: 'https://via.placeholder.com/150x150?text=Whiskas',
      ...
      DogFood(
        ...
        category: 'Dry Food',
        price: 85000,
        imageUrl: 'https://via.placeholder.com/150x150?text=Pedigree',
      ...
      CatFood(
        ...
        category: 'Dry Food',
        price: 120000,
        imageUrl: 'https://via.placeholder.com/150x150?text=Pro+Plan',
      ...
      PetFoodModel(
        ...
        category: 'Seeds',
        price: 75000,
        imageUrl: 'https://via.placeholder.com/150x150?text=Bird+Food',
      ...
      DogFood(
        ...
        category: 'Dry Food',
        price: 200000,
        imageUrl: 'https://via.placeholder.com/150x150?text=Hills',
